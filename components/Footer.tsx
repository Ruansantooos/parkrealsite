        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-10 text-center lg:text-left">
          ...
          <nav className="flex flex-wrap gap-x-8 gap-y-3">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="text-[#71717a] text-sm font-medium hover:text-[#f0f0f0] transition-colors duration-200"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="WhatsApp"
              className="w-9 h-9 rounded-full border border-[#333333] flex items-center justify-center text-[#71717a] hover:border-[#4DFFA0]/60 hover:bg-[#4DFFA0]/10 hover:text-[#f0f0f0] transition-all duration-200"
            >
